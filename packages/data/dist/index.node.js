...
var SemaphoreEthers = /** @class */ (function () {
    ...
    function SemaphoreEthers(networkOrEthereumURL, options) {
        ...
        switch (options.provider) {
            case "infura":
                provider = new providers.InfuraProvider(networkOrEthereumURL, options.apiKey);
                break;
            case "alchemy":
                provider = new providers.AlchemyProvider(networkOrEthereumURL, options.apiKey);
                break;
            case "cloudflare":
                provider = new providers.CloudflareProvider(networkOrEthereumURL, options.apiKey);
                break;
            case "etherscan":
                provider = new providers.EtherscanProvider(networkOrEthereumURL, options.apiKey);
                break;
            case "pocket":
                provider = new providers.PocketProvider(networkOrEthereumURL, options.apiKey);
                break;
            case "ankr":
        ...
        this._contract = new contracts.Contract(options.address, SemaphoreABI, provider);
    }
...
function getSupportedNetworks() {
    return Object.values(exports.SupportedNetwork);
}
...
function request(url, config) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios__default["default"](url, __assign({ headers: __assign({ "Content-Type": "application/json" }, config === null || config === void 0 ? void 0 : config.headers) }, config))];
                case 1:
                    data = (_a.sent()).data;
...
var SemaphoreSubgraph = /** @class */ (function () {
    ...
    function SemaphoreSubgraph(networkOrSubgraphURL) {
        if (networkOrSubgraphURL === void 0) { networkOrSubgraphURL = exports.SupportedNetwork.SEPOLIA; }
