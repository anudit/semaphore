...
var HeyAuthn = /** @class */ (function () {
    ...
    HeyAuthn.fromRegister = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var registrationOptions, id, identity$1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        registrationOptions = server.generateRegistrationOptions(options);
                        return [4 /*yield*/, browser.startRegistration(registrationOptions)];
                    case 1:
                        id = (_a.sent()).id;
                        identity$1 = new identity.Identity(id);
                        return [2 /*return*/, new HeyAuthn(identity$1)];
                }
            });
        });
    };
    ...
    HeyAuthn.fromAuthenticate = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var authenticationOptions, id, identity$1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        authenticationOptions = server.generateAuthenticationOptions(options);
                        return [4 /*yield*/, browser.startAuthentication(authenticationOptions)];
                    case 1:
                        id = (_a.sent()).id;
                        identity$1 = new identity.Identity(id);
                        return [2 /*return*/, new HeyAuthn(identity$1)];
...
Object.defineProperty(exports, 'Identity', {
    enumerable: true,
    get: function () { return identity.Identity; }
});
exports.HeyAuthn = HeyAuthn;
